import logo from './samurai_image.jpg';
import hacker from './hacker-cropped.png';
...
export {
    logo, hacker, skills, slash, coding, shoqai, bilim_ordasy, bosch, discord, email, telegram_icon, github_icon, linked_icon, landmark, profile_image
}